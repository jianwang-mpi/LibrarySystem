...
<style type="text/CSS">
	...
	<body bgcolor="#FFFF99">
	<div align="center" class="style1 style2">新 增 图 书
	</div>
	<center>
	<form action="addResponse.jsp" method="post">
		<table border="2" bordercolor="black" bgcolor="">
			...
			<tr>
				<td height="28">作者</td>
				<td><input type="text" name="author" maxlength="20" style="width:150"></td>
			</tr>
			<tr>
				<td height="28">出版时间</td>
				<td><input type="text" name="year" maxlength="20" style="width:150"></td>
			</tr>
						<tr>
				<td height="28">单价</td>
				<td><input type="text" name="price" maxlength="20" style="width:150"></td>
			</tr>
			</tbody>
		</table>
